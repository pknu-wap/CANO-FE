...
//     final userResponse = ref.watch(userInfoProvider);
//
...
//                 Text(
//                   "${userResponse.name}${AppStrings.coffeePreferenceText}",
...
//                       ),
//                       selected: _intensityEngToKor(userResponse.acidity) ==
//                           intensitys[index],
...
//                           side: BorderSide(
//                             color: userResponse.acidity?.description ==
//                                     intensitys[index]
...
// }
//
// String _intensityEngToKor(String intensityEng) {
//   switch (intensityEng) {
