      ...
      children: [
        ...
        Row(
          children: [
            ...
            SquareButton(
              onTap: () => ref.watch(userInfoProvider.notifier).setAge(10),
              onClear: () => ref.watch(userInfoProvider.notifier).setAge(0),
              text: "10대",
              size: 85,
              age: 10,
            ...
            SizedBox(width: 10),
            SquareButton(
                onTap: () => ref.watch(userInfoProvider.notifier).setAge(20),
                onClear: () => ref.watch(userInfoProvider.notifier).setAge(0),
                text: "20대",
                size: 85,
                age: 20,
            ...
            SizedBox(width: 10),
            SquareButton(
                onTap: () => ref.watch(userInfoProvider.notifier).setAge(30),
                onClear: () => ref.watch(userInfoProvider.notifier).setAge(0),
                text: "30대",
                size: 85,
                age: 30,
        ...
        Row(
          children: [
            ...
            SquareButton(
                onTap: () => ref.watch(userInfoProvider.notifier).setAge(40),
                onClear: () => ref.watch(userInfoProvider.notifier).setAge(0),
                text: "40대",
                size: 85,
                age: 40,
            ...
            SizedBox(width: 10),
            SquareButton(
                onTap: () => ref.watch(userInfoProvider.notifier).setAge(50),
                onClear: () => ref.watch(userInfoProvider.notifier).setAge(0),
                text: "50대",
                size: 85,
                age: 50,
            ...
            SizedBox(width: 10),
            SquareButton(
                onTap: () => ref.watch(userInfoProvider.notifier).setAge(60),
                onClear: () => ref.watch(userInfoProvider.notifier).setAge(0),
                text: "60대\n이상",
                size: 85,
                age: 60,
        ...
        Padding(
          ...
          child: CustomButton(
            ...
            onPressed: () {
              if (userInfo.name != "" &&
                  userInfo.age != 0 &&
                  userInfo.gender != null) context.push('/coffee_preference');
            },
          ),
        )
      ],
